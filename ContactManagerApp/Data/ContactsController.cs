...
namespace ContactManagerApp.Data
{
    ...
    {
        private readonly ContactManagerAppContext _context;

        public ContactsController(ContactManagerAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Contact != null ? 
                          ...
                          Problem("Entity set 'ContactManagerAppContext.Contact'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContactManagerAppContext.Contact'  is null.");
            }
            var contact = await _context.Contact.FindAsync(id);
            if (contact != null)
            {
